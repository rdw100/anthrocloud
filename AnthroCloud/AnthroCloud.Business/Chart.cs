...
namespace AnthroCloud.Business
{
    ...
    public class Chart : IGrowthChart
    {
        ...
        public List<LengthHeightForAge> ListLengthHeightForAge(Sexes sex, byte newX, decimal newY)
        {
            ...
            // Add Score Record with Interpolated Data for Chart
            lhfaCurves.Insert(smallNearElement + 1, new LengthHeightForAge { Month = newX, Score = newY, P3 = newP3, P15 = newP15, P50 = newP50, P85 = newP85, P97 = newP97, Sd3neg = newSd3neg, Sd2neg = newSd2neg, Sd0 = newSd0, Sd2 = newSd2, Sd3 = newSd3 });
