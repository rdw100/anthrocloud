...
namespace AnthroCloud.Entities.Migrations
{
    ...
    [Migration("20221020161302_AssessmentDb_Measures_New")]
    partial class AssessmentDb_Measures_New
    {
            ...
            modelBuilder.Entity("AnthroCloud.Entities.Patient", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            PatientId = 1,
                            DateOfBirth = new DateTime(2021, 10, 20, 0, 0, 0, 0, DateTimeKind.Local),
                            FirstName = "John",
                            LastName = "Smith",
                            Sex = (byte)0
                        },
                        ...
                        {
                            PatientId = 2,
                            DateOfBirth = new DateTime(2020, 10, 20, 0, 0, 0, 0, DateTimeKind.Local),
                            FirstName = "Juana",
                            LastName = "Diaz",
                            Sex = (byte)1
                        });
            ...
            modelBuilder.Entity("AnthroCloud.Entities.Visit", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            VisitId = 1,
                            DateOfVisit = new DateTime(2022, 1, 20, 0, 0, 0, 0, DateTimeKind.Local),
                        ...
                        {
                            VisitId = 2,
                            DateOfVisit = new DateTime(2022, 7, 20, 0, 0, 0, 0, DateTimeKind.Local),
                        ...
                        {
                            VisitId = 3,
                            DateOfVisit = new DateTime(2021, 10, 20, 0, 0, 0, 0, DateTimeKind.Local),
                        ...
                        {
                            VisitId = 4,
                            DateOfVisit = new DateTime(2021, 4, 20, 0, 0, 0, 0, DateTimeKind.Local),
