...
{
    public partial class AnthroCloudContextMsSql : DbContext
    {
        public AnthroCloudContextMsSql()
        {
        }

        public AnthroCloudContextMsSql(DbContextOptions<AnthroCloudContextMsSql> options)
            : base(options)
        {
        }
